<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="10DimensionSpecifiedApproach.aspx.vb" Inherits="GSBWeb._12CounterpartyExposure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Dimension Report - Breakdown By Specified Approach</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

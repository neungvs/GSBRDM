<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="7DimensionCRating.aspx.vb" Inherits="GSBWeb._7DimensionCRating" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Dimension Report - Breakdown By External Credit Rating</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

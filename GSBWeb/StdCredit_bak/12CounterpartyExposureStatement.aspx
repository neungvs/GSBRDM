<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="12CounterpartyExposureStatement.aspx.vb" Inherits="GSBWeb._11CouterpartyList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Counterparty Exposure Statement</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="false">
            ...
            <table>
                <tr><td colspan="3"> Counterpaty Selection</td> </tr>
                <tr>
                    <td>Search names of Counterpaties that begin with:</td>
                    <td style="width:50px">&nbsp;</td>
                    <td align="center">select Counterpaty</td>
                </tr>
                <tr>
                    <td><asp:TextBox ID="TxtObligorNameSch" runat="server"></asp:TextBox> <asp:Button ID="BthObligorNameSch" runat="server" Text=" " /></td>
                    <td>&nbsp;</td>
                    <td><asp:DropDownList ID="DrlObligorName" runat="server" DataTextField="OBLIGORNAME" DataValueField="OBLIGORNAME" Width="200px"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>

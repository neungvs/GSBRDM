<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="1CRDashboard.aspx.vb" Inherits="GSBWeb._1CRDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1>Credit Risk Dashboard</h1></br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

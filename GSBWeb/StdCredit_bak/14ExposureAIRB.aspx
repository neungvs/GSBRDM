<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="14ExposureAIRB.aspx.vb" Inherits="GSBWeb._14ExposureAIRB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Exposure Statement Approach - FIRB</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="15ExposureFIRB.aspx.vb" Inherits="GSBWeb._15ExposureFIRB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Exposure Statement Approach - Std Comp</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

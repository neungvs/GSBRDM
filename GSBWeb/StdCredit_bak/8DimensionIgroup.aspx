<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="8DimensionIgroup.aspx.vb" Inherits="GSBWeb._8DimensionIgroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Dimension Report - Breakdown By Obligor Industry Group</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

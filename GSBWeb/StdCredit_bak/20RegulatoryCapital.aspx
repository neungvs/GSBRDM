<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="20RegulatoryCapital.aspx.vb" Inherits="GSBWeb._20RegulatoryCapital" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Regulatory Capital Summary</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

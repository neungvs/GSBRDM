...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Exposure Tranche Statement</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="false">
            ...
            <table>
                <tr><td colspan="3"> Exposure Selection</td> </tr>
                <tr>
                ...
                <tr>
                    <td><asp:TextBox ID="TxtAccountRefCDSch" runat="server"></asp:TextBox> <asp:Button ID="BthAccountRefCDcSch" runat="server" Text=" " /></td>
                    <td>&nbsp;</td>
                    <td><asp:DropDownList ID="DrlAccountRefCD" runat="server" DataTextField="ACCOUNTREFCD" DataValueField="ACCOUNTREFCD" Width="200px"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>

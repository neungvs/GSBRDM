<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="13ExposureTranche.aspx.vb" Inherits="GSBWeb._13ExposureTranche" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
      <script type="text/javascript">
       ...
       {
            var DrlTime = document.getElementById("<%=DrlTime.ClientID%>");
  ...
  <h1>Exposure Statement Approach - AIRB</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

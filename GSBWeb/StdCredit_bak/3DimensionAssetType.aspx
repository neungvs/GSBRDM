<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="3DimensionAssetType.aspx.vb" Inherits="GSBWeb._3DimensionOrigin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Dimension Report - Breakdown By Asset Type</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

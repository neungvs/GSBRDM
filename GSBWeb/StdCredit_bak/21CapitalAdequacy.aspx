<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="21CapitalAdequacy.aspx.vb" Inherits="GSBWeb._21CapitalAdequacy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Capital Adequacy By Risk</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="2DimensionArrearsStatus.aspx.vb" Inherits="GSBWeb._2BreakdownByAType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Dimension Report - Breakdown By Arrears Status</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="6DimensionExposure.aspx.vb" Inherits="GSBWeb._6DimensionExposure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Dimension Report - Breakdown By Exposure Currency</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

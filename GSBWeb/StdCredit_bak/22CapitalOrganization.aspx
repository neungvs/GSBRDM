<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="22CapitalOrganization.aspx.vb" Inherits="GSBWeb._22CapitalOrganization" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <h1>Capital Adequacy By Organization Structure</h1> </br>
        <table>
            <tr>
                <td>วันที่ (Time)</td>
                <td>

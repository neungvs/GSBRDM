<%@ Page Title="แก้ไขข้อมูล LN70" Language="vb" AutoEventWireup="false" MasterPageFile="../Site.Master"
    CodeBehind="LN70_RejList.aspx.vb" Inherits="GSBWeb.LN70_List" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default">
                <div class="NormalHeader" style="/*text-align: left; font-size: medium; font-weight: bold;
                    ...
                    ข้อมูลรายการที่ถูก Reject LN70</div>
                <table align="left" width="100%">
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold; text-align:left; font-size: x-small">
                            ...
                            <asp:GridView ID="gvLN70" runat="server" AutoGenerateColumns="False" PageSize="20"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText=" เลขที่บัญชี">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="hpSubAccNo" runat="server" CommandName="Select"></asp:LinkButton>
                                            <asp:HiddenField ID="HF_TMP_LN70ID" runat="server" />
                                    ...
                                    <asp:TemplateField HeaderText="OUTSTBALANCE" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblOUTSTBALANCE" Text='<%# Bind("OUTSTBALANCE") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Right" BorderColor="Gray" BorderWidth="1" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="ACRINTLASTMLY" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblACRINTLASTMLY" Text='<%# Bind("ACRINTLASTMLY") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Right" BorderColor="Gray" BorderWidth="1" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="INT_REONGNITE_STATUS">
                                        <ItemTemplate>
                                            <asp:Label ID="INT_REONGNITE_STATUS" Text='<%# Bind("INT_REONGNITE_STATUS") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" Width="50px" />
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" Width="50px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="ACC_MATUREDATE">
                                        <ItemTemplate>
                                            <asp:Label ID="ACC_MATUREDATE" Text='<%# Bind("ACC_MATUREDATE") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="LNTYPECODE">
                                        <ItemTemplate>
                                            <asp:Label ID="LNTYPECODE" Text='<%# Bind("LNTYPECODE") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="LNMKTCODE">
                                        <ItemTemplate>
                                            <asp:Label ID="LNMKTCODE" Text='<%# Bind("LNMKTCODE") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="center" BorderColor="Gray" BorderWidth="1" />

...
Public Class IN51_RejList

    Inherits System.Web.UI.Page

    Dim inBiz As New IN51Biz
    ...
    Private Sub LoadData()
        ...
        gvIN51.DataSource = inBiz.GetDataIN51()
        gvIN51.DataBind()

    End Sub


    Protected Sub gvIN51_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvIN51.RowDataBound

        Dim hpACCNO As LinkButton = CType(e.Row.FindControl("hpACCNO"), LinkButton)
        Dim HF_TMP_IN51ID As HiddenField = CType(e.Row.FindControl("HF_TMP_IN51ID"), HiddenField)
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            HF_TMP_IN51ID.Value = DataBinder.Eval(e.Row.DataItem, "TMP_IN51ID").ToString()

        End If

    End Sub

    Protected Sub gvIN51_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvIN51.SelectedIndexChanged

        Dim lblCifNumber As Label = CType(gvIN51.SelectedRow.FindControl("lblCifNumber"), Label)
        Dim hpACCNO As LinkButton = CType(gvIN51.SelectedRow.FindControl("hpACCNO"), LinkButton)
        Dim HF_TMP_IN51ID As HiddenField = CType(gvIN51.SelectedRow.FindControl("HF_TMP_IN51ID"), HiddenField)

        ClearSession()
        Session("CifNumber") = lblCifNumber.Text
        Session("ACCNO") = hpACCNO.Text
        Session("TMPID") = HF_TMP_IN51ID.Value

        Response.Redirect("IN51_RejEdit.aspx")
    ...
    Private Sub SearchData()
        ...
        gvIN51.DataSource = inBiz.GetIN51ByCriteria(Convert.ToString(Session("CifNum")), Convert.ToString(Session("AccNo")), Convert.ToString(Session("Name")), Convert.ToString(Session("SurName")))
        gvIN51.DataBind()
    ...
    Protected Sub gvIN51_PageIndexChanging_PageIndexChanging(sender As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gvIN51.PageIndexChanging

        gvIN51.PageIndex = e.NewPageIndex
    ...
    Protected Sub btnReport_Click(sender As Object, e As EventArgs) Handles btnReport.Click
        ...
        viewer.LocalReport.ReportPath = Server.MapPath("~/Reports/IN51_RejReport.rdlc")
        ...
        Dim fileName As String = "IN51_RejectDetail_" + String.Format("{0:ddMMyyyy}", Date.Now) + ".pdf"

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="TF_FLOAT_RejList.aspx.vb" Inherits="GSBWeb.TF_FLOAT_RejList" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
   ...
   <div class="panel panel-default">
        <div class="NormalHeader" style="/*text-align: left; font-size:medium; font-weight: bold; background: #FF388C;
            ...
            ข้อมูลรายการที่ถูก Reject TF_FLOAT</div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText=" เลขที่บัญชี">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="HF_TMP_TF_FLOATID" runat="server" />

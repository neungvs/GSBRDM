...
Public Class TF_NM_RejEdit
    ...
    Private Sub GetRejData(tempId As String)
        ...
        gvTF_NM.DataSource = tfBiz.GetRejData(tempId)
        gvTF_NM.DataBind()
    ...
    Protected Sub gvTF_NM_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvTF_NM.SelectedIndexChanged
        ...
        Dim HF_DataRecordID As HiddenField = CType(gvTF_NM.SelectedRow.FindControl("HF_DataRecordID"), HiddenField)

        Dim lblColumnName As Label = CType(gvTF_NM.SelectedRow.FindControl("lblColumnName"), Label)

        Dim lblColumnValue As Label = CType(gvTF_NM.SelectedRow.FindControl("lblColumnValue"), Label)

        Dim lblRejectReason As Label = CType(gvTF_NM.SelectedRow.FindControl("lblRejectReason"), Label)

        Dim lblSeq As Label = CType(gvTF_NM.SelectedRow.FindControl("lblSeq"), Label)


        Dim HF_ColumnName As HiddenField = CType(gvTF_NM.SelectedRow.FindControl("HF_ColumnName"), HiddenField)
    ...
    Private Sub SetValidation(columnName As String)
        ...
        If (New String() {"CREATIONDATE", "StartDate"}).Contains(columnName) Then
    ...
    Protected Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        lblModalTitle.Text = "คำอธิบายรูปแบบข้อมูลบัญชีเงินกู้ในธุรกิจ Trade Finance ที่เป็น NPL -> TF_NM"
    ...
    Protected Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        ...
        Response.Redirect("TF_NM_RejList.aspx")

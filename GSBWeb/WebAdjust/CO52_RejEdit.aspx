<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="CO52_RejEdit.aspx.vb" Inherits="GSBWeb.CO52_RejEdit" %>
                        ...
                        <td width="90%" colspan="4">
                            <div class="panel panel-default" style="border: none">
                                ...
                                <table width="100%" style="border-width: 1px; border-color: Gray">
                                    <tr width="100%">
                                        <td>
                                            <asp:GridView ID="gvCO52" runat="server" AutoGenerateColumns="False" PageSize="20"
            ...
            <asp:UpdatePanel ID="upModal" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header NormalSubItems" style="/*background: #FF388C; color: White; text-align: left;
                            font-weight: bold*/">
                            <asp:Label ID="lblModalTitle" Style="font-size: medium" runat="server" Text="sssssss"></asp:Label></div><div class="modal-body">
                            <table align="center" style="border: thin solid #EEE; margin-left: 0px; margin-top: 0px;
                            ...
                            <a 
                                href="WF52_RejEdit.aspx">WF52_RejEdit.aspx</a><button class="btn btn-info ButtonGrayStyle" style="/*background: #FF388C;*/" data-dismiss="modal" aria-hidden="true">

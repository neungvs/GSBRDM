<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="Swap_RejEdit.aspx.vb" Inherits="GSBWeb.Swap_RejEdit" %>
                ...
                <asp:Label ID="lblLN70" ForeColor="White" runat="server" Text="แก้ไขข้อมูล LN70"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%; text-align: right">
                            &nbsp;
                            <asp:Button ID="btnClose" CausesValidation="false" class="btn btn-primary ButtonGrayStyle" runat="server"
                                Text="ยกเลิก" Width="110px" />
                        </td>
                        <td>
                        </td>
                    </tr>
            ...
            <asp:UpdatePanel ID="upModal" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header NormalHeader" style="/*background: #FF388C;8*/ color: Black; text-align: left;
                            font-weight: bold">
                            ...
                            <table align="center" style="border: thin solid #CCC; margin-left: 0px; margin-top: 0px;
                                ...
                                <tr style="background: #CCC; color: Black; font-weight: bold">
                                    ...
                                    <td style="text-align: left; vertical-align: top; font-size: medium; border: thin solid #CCC;"
                                        width="200px">
                                        <span lang="TH">GL Account กรณีที่สัญญาอนุพันธ์ <br />(Derivative) </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #CCC;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ASSET_GL_CODE</span> </td><td style="text-align: left; font-size: medium; border: thin solid #CCC; vertical-align: top">
                                    ...
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #CCC;"
                                        ...
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">STARTDATE</span> </td><td style="text-align: left; border: thin solid #CCC; vertical-align: top">
                                    ...
                                    <td style="text-align: left; border: thin solid #CCC; font-size: medium; vertical-align: top;"
                                        width="200px">
                                        <span lang="TH">เป็นข้อมูลวันที่ครบกำหนดสัญญา</span> </td><td style="text-align: left; vertical-align: top; border: thin solid #CCC;">
                            ...
                            <button class="btn btn-info ButtonGrayStyle" style="/*background: #EEE*/" data-dismiss="modal" aria-hidden="true">

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FW53_RejEdit.aspx.vb" Inherits="GSBWeb.FW53_RejEdit" %>
                        ...
                        <td width="90%" colspan="4">
                            <div class="panel panel-default" style="border: none">
                                ...
                                <table width="100%" style="border-width: 1px; border-color: Gray">
                                    <tr width="100%">
                                        <td>
                                            <asp:GridView ID="gvFW53" runat="server" AutoGenerateColumns="False" PageSize="20"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="รายการที่">
                                                        ...
                                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" ForeColor="Black" BorderWidth="1" CssClass="td-center" />
                                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText=" ชื่อรายการ">
                                                        ...
                                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" ForeColor="Black" BorderWidth="1" />
                        ...
                        <td width="90%" colspan="4">
                            <asp:Panel ID="pnlEdit" runat="server" Width="100%" Visible="false">
                                <div class="panel panel-danger" width="100%">
                                    <div class="NormalHeader" style="/*text-align: left; font-weight: bold; background-color: #F279AF;
                                        */color:Black">
                                        รายการที่แก้ไข</div>
                                    <table width="100%">
                                        <%--   <tr>
            ...
            <asp:UpdatePanel ID="upModal" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header ButtonGrayStyle" style="/*background: #FF388C; color: White;*/ text-align: left;
                            font-weight: bold;">
                            <asp:Label ID="lblModalTitle" Style="font-size: medium" runat="server" Text="sssssss"></asp:Label></div><div class="modal-body">
                            <table align="center" style="border: thin solid #CCC; margin-left: 0px; margin-top: 0px;
                                ...
                                <tr style="background: #CCC; color: Black; font-weight: bold">
                                    ...
                                    <td style="text-align: left; vertical-align: top; font-size: medium; border: thin solid #CCC;"
                                        width="200px">
                                        <span lang="TH">รหัสบัญชีของธนาคาร<br />(Derivative) </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                    ...
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #CCC;"
                                        width="200px">
                                        <span lang="TH">วันที่ของข้อมูล </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #CCC;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">AS_OF_DATE</span> </td><td style="text-align: left; font-size: medium; border: thin solid #CCC; vertical-align: top">
                                    ...
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #CCC;"
                                        width="200px">
                                        <span lang="TH">วันที่เริ่มต้นของรายการ</span> </td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #CCC;">
                                    ...
                                    <td style="text-align: left; border: thin solid #C0C0C0; font-size: medium; vertical-align: top;"
                                        width="200px">
                                        <span lang="TH">เป็นข้อมูลวันที่ครบกำหนดสัญญา</span> </td><td style="text-align: left; vertical-align: top; border: thin solid #EEE;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">MATURITY_DATE</span> </td><td style="text-align: left; border: thin solid #EEE; vertical-align: top">

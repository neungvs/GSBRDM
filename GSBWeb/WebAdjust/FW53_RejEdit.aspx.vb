...
Public Class FW53_RejEdit
    ...
    Protected Sub gvFW53_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvFW53.SelectedIndexChanged
        ...
        Dim HF_DataRecordID As HiddenField = CType(gvFW53.SelectedRow.FindControl("HF_DataRecordID"), HiddenField)

        Dim lblColumnName As Label = CType(gvFW53.SelectedRow.FindControl("lblColumnName"), Label)

        Dim lblColumnValue As Label = CType(gvFW53.SelectedRow.FindControl("lblColumnValue"), Label)

        Dim lblRejectReason As Label = CType(gvFW53.SelectedRow.FindControl("lblRejectReason"), Label)

        Dim lblSeq As Label = CType(gvFW53.SelectedRow.FindControl("lblSeq"), Label)


        Dim HF_ColumnName As HiddenField = CType(gvFW53.SelectedRow.FindControl("HF_ColumnName"), HiddenField)
    ...
    Private Sub GetRejData(tempId As String)
        ...
        gvFW53.DataSource = fwBiz.GetRejData(tempId)
        gvFW53.DataBind()
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            fwBiz.Save_edit(Session("TMPID").ToString(), HF_ColumnValue.Value, txtEditValue.Text)
    ...
    Private Sub SetValidation(columnName As String)
        ...
        If (New String() {"MATURITY_DATE", "ORIGINATION_DATE", "SETTLEMENT_DATE", "AS_OF_DATE"}).Contains(columnName) Then
    ...
    Protected Sub gvFW53_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvFW53.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            ElseIf HF_ColumnName.Value = "ORIGINATION_DATE" Then
                lblColumnName.Text = "วันที่เริ่มต้นของรายการ (ORIGINATION_DATE)"

            ElseIf HF_ColumnName.Value = "MATURITY_DATE" Then
                lblColumnName.Text = "เป็นข้อมูลวันที่ครบกำหนดสัญญา (MATURITY_DATE)"
    ...
    Protected Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        lblModalTitle.Text = "คำอธิบายรูปแบบข้อมูลยอดคงเหลือสิ้นวันของธุรกรรม FX -> FW53"
    ...
    Protected Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        ...
        Response.Redirect("FW53_RejList.aspx")

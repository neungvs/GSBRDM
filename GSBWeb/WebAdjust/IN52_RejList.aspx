<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="IN52_RejList.aspx.vb" Inherits="GSBWeb.IN52_RejList" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default">
                <div class="NormalHeader" style="/*text-align: left; font-size: medium; font-weight: bold;
                    ...
                    ข้อมูลรายการที่ถูก Reject IN52</div>
                            ...
                            <asp:GridView ID="gvIN52" runat="server" AutoGenerateColumns="False" PageSize="20"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText=" เลขที่บัญชี">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="hpAccNo" style="Font-Size:small"  runat="server" CommandName="Select"></asp:LinkButton>
                                            <asp:HiddenField ID="HF_TMP_IN52ID" runat="server" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black"/>
                                        <ItemStyle HorizontalAlign="Center"  BorderColor="Gray" BorderWidth="1" />
                                     ...
                                     <asp:TemplateField HeaderText="ชื่อลูกค้า นามสกุล" Visible="true">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" Width="400px" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Left" BorderColor="Gray" BorderWidth="1" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="CUR_BOOK_BAL">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCUR_BOOK_BAL" Text='<%# Bind("CUR_BOOK_BAL") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" Width="50px" />
                                        <ItemStyle HorizontalAlign="Right" BorderColor="Gray" BorderWidth="1" Width="50px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="GSB_INT_ACCRUAL">
                                        <ItemTemplate>
                                            <asp:Label ID="lblGSB_INT_ACCRUAL" Text='<%# Bind("GSB_INT_ACCRUAL") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="ORIGINATION_DATE">
                                        <ItemTemplate>
                                            <asp:Label ID="lblORIGINATION_DATE" Text='<%# Bind("ORIGINATION_DATE") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />

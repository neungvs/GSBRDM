<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TF_FIXED_RejList.aspx.vb" Inherits="GSBWeb.TF_FIXED_RejList" %>
...
<div class="panel panel-default">
        <div class="NormalHeader" style="/*text-align: left; font-size:medium; font-weight: bold; background: #FF388C;
            ...
            ข้อมูลรายการที่ถูก Reject TF_FIXED</div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText=" เลขที่บัญชี">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="HF_TMP_TF_FIXEID" runat="server" />
                            ...
                            <asp:TemplateField HeaderText="EndDate">
                                <ItemTemplate>
                                    <asp:Label ID="EndDate" Text='<%# Bind("EndDate") %>' runat="server"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center"  BorderColor="#EEEEEE" BackColor="#CCCCCC"   BorderWidth="1" CssClass="td-center" ForeColor="Black" />
                                <ItemStyle HorizontalAlign="center" BorderColor="Gray"  BorderWidth="1" />
                            </asp:TemplateField>

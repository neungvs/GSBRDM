...
Public Class IN52_RejEdit
    ...
    Private Sub GetRejData(tempId As String)
        ...
        gvIN52.DataSource = inBiz.GetRejData(tempId)
        gvIN52.DataBind()
    ...
    Protected Sub gvIN52_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvIN52.SelectedIndexChanged
        ...
        Dim HF_DataRecordID As HiddenField = CType(gvIN52.SelectedRow.FindControl("HF_DataRecordID"), HiddenField)

        Dim lblColumnName As Label = CType(gvIN52.SelectedRow.FindControl("lblColumnName"), Label)

        Dim lblColumnValue As Label = CType(gvIN52.SelectedRow.FindControl("lblColumnValue"), Label)

        Dim lblRejectReason As Label = CType(gvIN52.SelectedRow.FindControl("lblRejectReason"), Label)

        Dim lblSeq As Label = CType(gvIN52.SelectedRow.FindControl("lblSeq"), Label)


        Dim HF_ColumnName As HiddenField = CType(gvIN52.SelectedRow.FindControl("HF_ColumnName"), HiddenField)
    ...
    Protected Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        lblModalTitle.Text = "คำอธิบายรูปแบบข้อมูลยอดคงเหลือหลักทรัพย์ของธุรกรรม FI,EQ,Repo ขาปล่อยกู้ -> IN52"
    ...
    Protected Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        ...
        Response.Redirect("IN52_RejList.aspx")

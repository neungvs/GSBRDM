...
Public Class CO52_RejEdit
    ...
    Protected Sub gvCO52_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvCO52.SelectedIndexChanged
        ...
        Dim HF_DataRecordID As HiddenField = CType(gvCO52.SelectedRow.FindControl("HF_DataRecordID"), HiddenField)

        Dim lblColumnName As Label = CType(gvCO52.SelectedRow.FindControl("lblColumnName"), Label)

        Dim lblColumnValue As Label = CType(gvCO52.SelectedRow.FindControl("lblColumnValue"), Label)

        Dim lblRejectReason As Label = CType(gvCO52.SelectedRow.FindControl("lblRejectReason"), Label)

        Dim lblSeq As Label = CType(gvCO52.SelectedRow.FindControl("lblSeq"), Label)


        Dim HF_ColumnName As HiddenField = CType(gvCO52.SelectedRow.FindControl("HF_ColumnName"), HiddenField)
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            coBiz.Save_edit(Session("TMPID").ToString(), HF_ColumnValue.Value, txtEditValue.Text)
    ...
    Private Sub GetRejData(tempId As String)
        ...
        gvCO52.DataSource = coBiz.GetRejData(tempId)
        gvCO52.DataBind()
    ...
    Protected Sub gvCO52_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvCO52.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            If HF_ColumnName.Value = "AS_OF_DATE" Then
    ...
    Protected Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        lblModalTitle.Text = "คำอธิบายรูปแบบข้อมูลยอดคงเหลือหลักประกันของธุรกรรม Repo,SBL <br /> และข้อมูลหลักทรัพย์ที่ยืมและให้ยืม -> CO52"
    ...
    Protected Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        ...
        Response.Redirect("CO52_RejList.aspx")

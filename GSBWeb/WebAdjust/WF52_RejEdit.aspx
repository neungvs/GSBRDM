<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WF52_RejEdit.aspx.vb" Inherits="GSBWeb.WF52_RejEdit" %>
            ...
            <td colspan="6" style="background-color: #FF388C; font-size: medium; font-weight: bold;
                ...
                <asp:Label ID="lblLN70" ForeColor="White" runat="server" Text="แก้ไขข้อมูล LN70"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td align="right" style="font-weight: bold; font-size: x-small; width: 13%">
                            &nbsp;
                        </td>
                        <td style="width: 20%">
                            &nbsp;
                        ...
                        <td width="90%" colspan="4">
                            <div class="panel panel-default" style="border: none">
                                ...
                                <table width="100%" style="border-width: 1px; border-color: Gray">
                                    <tr width="100%">
                                        <td>
                                            <asp:GridView ID="gvWF52" runat="server" AutoGenerateColumns="False" PageSize="20"
                            ...
                            <table align="center" style="border: thin solid #C0C0C0; margin-left: 0px; margin-top: 0px;
                                ...
                                <tr style="background: #FF388C; color: White; font-weight: bold">
                                    ...
                                    <td style="text-align: left; vertical-align: top; font-size: medium; border: thin solid #C0C0C0;"
                                        width="200px">
                                        <span lang="TH">รหัสบัญชีของธนาคาร </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">GL_ACCOUNT_ID</span> </td><td style="text-align: left; font-size: medium; border: thin solid #C0C0C0; vertical-align: top">
                                    ...
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;"
                                        width="200px">
                                        <span lang="TH">อัตราดอกเบี้ยปัจจุบันที่ลูกค้าจ่าย </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">CUR_GROSS_RATE</span> </td><td style="text-align: left; font-size: medium; border: thin solid #C0C0C0; vertical-align: top">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">1. เป็นตัวเลข <br />2.  มีขนาดไม่เกิน 10 (รวมทศนิยม) </span></td></tr><tr style="background-color: #FFCEDB">
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;"
                                        width="200px">
                                        <span lang="TH">วันที่ครบกำหนดส่งมอบ</span> </td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">SETTLEMENT_DATE</span> </td><td style="text-align: left; border: thin solid #C0C0C0; vertical-align: top">
                                    ...
                                    <td style="text-align: left; border: thin solid #C0C0C0; font-size: medium; vertical-align: top;"
                                        width="200px">
                                        <span lang="TH">วันที่เริ่มดำเนินการกับธนาคารของแต่ละบัญชี</span> </td><td style="text-align: left; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ORIGINATION_DATE</span> </td><td style="text-align: left; border: thin solid #C0C0C0; vertical-align: top">

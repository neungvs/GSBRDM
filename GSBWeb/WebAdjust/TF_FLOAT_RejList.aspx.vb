...
Public Class TF_FLOAT_RejList
    ...
    Private Sub LoadData()
        ...
        gvTF_FLOAT.DataSource = tfBiz.GetDataTF_FLOAT()
        gvTF_FLOAT.DataBind()
    ...
    Protected Sub gvTF_FLOAT_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvTF_FLOAT.RowDataBound
        ...
        Dim HF_TMP_TF_FLOATID As HiddenField = CType(e.Row.FindControl("HF_TMP_TF_FLOATID"), HiddenField)
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            HF_TMP_TF_FLOATID.Value = DataBinder.Eval(e.Row.DataItem, "TMP_TF_FLOATID").ToString()
    ...
    Private Sub SearchData()
        ...
        gvTF_FLOAT.DataSource = tfBiz.GetTF_FLOAT_ByCriteria(Convert.ToString(Session("CifNum")), Convert.ToString(Session("AccNo")), Convert.ToString(Session("Name")), Convert.ToString(Session("SurName")))
        gvTF_FLOAT.DataBind()

    End Sub


    Protected Sub gvTF_FLOAT_PageIndexChanging(sender As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gvTF_FLOAT.PageIndexChanging

        gvTF_FLOAT.PageIndex = e.NewPageIndex
        SearchData()
    ...
    Protected Sub gvTF_FLOAT_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvTF_FLOAT.SelectedIndexChanged
        ...
        Dim lblCifNumber As Label = CType(gvTF_FLOAT.SelectedRow.FindControl("lblCifNumber"), Label)
        Dim hpPositionId As LinkButton = CType(gvTF_FLOAT.SelectedRow.FindControl("hpPositionId"), LinkButton)
        Dim HF_TMP_TF_FLOATID As HiddenField = CType(gvTF_FLOAT.SelectedRow.FindControl("HF_TMP_TF_FLOATID"), HiddenField)

        ClearSession()
        Session("CifNumber") = lblCifNumber.Text
        Session("ACCNO") = hpPositionId.Text
        Session("TMPID") = HF_TMP_TF_FLOATID.Value

        Response.Redirect("TF_FLOAT_RejEdit.aspx")
    ...
    Protected Sub btnReport_Click(sender As Object, e As EventArgs) Handles btnReport.Click
        ...
        viewer.LocalReport.ReportPath = Server.MapPath("~/Reports/TF_FLOAT_RejReport.rdlc")
        ...
        Dim fileName As String = "TF_FLOAT_RejDetail_" + String.Format("{0:ddMMyyyy}", Date.Now) + ".pdf"

...
Public Class IN51_RejEdit
    ...
    Private Sub GetRejData(tempId As String)
        ...
        gvIN51.DataSource = inBiz.GetRejData(tempId)
        gvIN51.DataBind()
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            inBiz.Save_edit(Session("TMPID").ToString(), HF_ColumnValue.Value, txtEditValue.Text)
    ...
    Protected Sub gvIN51_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvIN51.SelectedIndexChanged
        ...
        Dim HF_DataRecordID As HiddenField = CType(gvIN51.SelectedRow.FindControl("HF_DataRecordID"), HiddenField)

        Dim lblColumnName As Label = CType(gvIN51.SelectedRow.FindControl("lblColumnName"), Label)

        Dim lblColumnValue As Label = CType(gvIN51.SelectedRow.FindControl("lblColumnValue"), Label)

        Dim lblRejectReason As Label = CType(gvIN51.SelectedRow.FindControl("lblRejectReason"), Label)

        Dim lblSeq As Label = CType(gvIN51.SelectedRow.FindControl("lblSeq"), Label)


        Dim HF_ColumnName As HiddenField = CType(gvIN51.SelectedRow.FindControl("HF_ColumnName"), HiddenField)
    ...
    Private Sub SetValidation(columnName As String)
        ...
        ElseIf (New String() {"CUR_GROSS_RATE"}).Contains(columnName) Then
            ...
            rgFormat.ValidationExpression = "^(?:[1-9][0-9]{0,9}|(?![0-9.]{11})(?:0\.[0-9]*[1-9][0-9]*|[1-9][0-9]*\.[0-9]+))$"
            rgFormat.ErrorMessage = "ข้อมูลต้องอยู่ในรูปแบบของตัวเลข 0-9 เท่านั้น และมีขนาดไม่เกิน 10 หลัก (รวมทศนิยม)"
            rgFormat.Enabled = True
    ...
    Protected Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        lblModalTitle.Text = "คำอธิบายรูปแบบข้อมูลยอดคงเหลือหลักทรัพย์ของธุรกรรม DF,Interbank ขาปล่อยกู้ -> IN51"
    ...
    Protected Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        ...
        Response.Redirect("IN51_RejList.aspx")

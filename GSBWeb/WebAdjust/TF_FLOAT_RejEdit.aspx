<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TF_FLOAT_RejEdit.aspx.vb" Inherits="GSBWeb.TF_FLOAT_RejEdit" %>
                ...
                <asp:Label ID="lblLN70" ForeColor="White" runat="server" Text="แก้ไขข้อมูล LN70"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%; text-align: right">
                            &nbsp;
                              <asp:Button ID="btnClose" CausesValidation="false" class="btn btn-primary" runat="server" Text="ยกเลิก" BackColor="#FF388C"
                                Width="110px" />
                        </td>
                        <td>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="90%" colspan="4">
                            <div class="panel panel-default" style="border: none">
                                <div class="panel-heading" style="text-align: left; font-weight: bold; height: 35px;
                                ...
                                <table width="100%" style="border-width: 1px; border-color: Gray">
                                    <tr width="100%">
                                        <td>
                                            <asp:GridView ID="gvTF_FLOAT" runat="server" AutoGenerateColumns="False" PageSize="20"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText=" ชื่อรายการ">
                                                        ...
                                                        <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />
                                                ...
                                                <HeaderStyle BackColor="#FF388C" Font-Size="Small" BorderColor="Gray" BorderWidth="1"
                                                    Height="35px" ForeColor="White" />
                                                <AlternatingRowStyle BackColor="#FFE8EE" BorderColor="Gray" BorderWidth="1" />
                                                <RowStyle Font-Size="Small" BackColor="#FFCEDB" BorderColor="Gray" BorderWidth="1" />
                                            </asp:GridView>
                                        </td>
                                    </tr>
                                </table>
            ...
            <asp:UpdatePanel ID="upModal" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header" style="background: #FF388C; color: White; text-align: left;
                            font-weight: bold">
                            ...
                            <table align="center" style="border: thin solid #C0C0C0; margin-left: 0px; margin-top: 0px;
                                ...
                                cssclass="footable">
                                <tr style="background: #FF388C; color: White; font-weight: bold">
                                    <td style="text-align: center; font-size: medium; border: thin solid #C0C0C0;" width="250px">
                                        <span lang="TH">ชื่อรายการ</span> </td><td style="text-align: center; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ชื่อฟิลด์</span> </td><td style="text-align: center; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">รูปแบบข้อมูล</span> </td></tr><tr style="background-color: #FFCEDB">
                                    <td style="text-align: left; vertical-align: top; font-size: medium; border: thin solid #C0C0C0;"
                                        width="200px">
                                        <span lang="TH">รหัสบัญชี </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">GL_ACCOUNT</span> </td><td style="text-align: left; font-size: medium; border: thin solid #C0C0C0; vertical-align: top">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ห้ามเป็นค่าว่าง </span></td></tr><tr style="background-color: #FFCEDB">
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;"
                                        width="200px">
                                        <span lang="TH">วันจ่ายเงินกู้ </span></td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">StartDate</span> </td><td style="text-align: left; font-size: medium; border: thin solid #C0C0C0; vertical-align: top">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">1. เป็นตัวเลข 8 หลัก <br />2. อยู่ในรูปแบบ ววดดปปปป โดยที่ ปปปป คือ ปี ค.ศ. </span></td></tr><tr style="background-color: #FFCEDB">
                                    <td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;"
                                        width="200px">
                                        <span lang="TH">วันสิ้นสุดสัญญา</span> </td><td style="text-align: left; font-size: medium; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">EndDate</span> </td><td style="text-align: left; border: thin solid #C0C0C0; vertical-align: top">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">1. เป็นตัวเลข 8 หลัก <br />2. อยู่ในรูปแบบ ววดดปปปป โดยที่ ปปปป คือ ปี ค.ศ. </span></td></tr><tr style="background-color: #FFCEDB">
                                    <td style="text-align: left; border: thin solid #C0C0C0; font-size: medium; vertical-align: top;"
                                        width="200px">
                                        <span lang="TH">สกุลเงิน</span> </td><td style="text-align: left; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">Currency_Original</span> </td><td style="text-align: left; border: thin solid #C0C0C0; vertical-align: top">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ห้ามเป็นค่าว่าง</span> </td></tr><tr style="background-color: #FFCEDB">
                                    <td style="text-align: left; border: thin solid #C0C0C0; font-size: medium; vertical-align: top;"
                                        width="200px">
                                        <span lang="TH">ระดับการจัดชั้นหนี้ตามยอดค้างชำระ</span> </td><td style="text-align: left; vertical-align: top; border: thin solid #C0C0C0;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ASSET_CLASS_TYPE</span> </td><td style="text-align: left; border: thin solid #C0C0C0; vertical-align: top; font-size: medium;">
                                        <span lang="TH" style="font-family: Tahoma; font-size: medium">ห้ามเป็นค่าว่าง </span></td></tr></table></div><div class="modal-footer" style="text-align: center">
                            <button class="btn btn-info" style="background: #FF388C" data-dismiss="modal" aria-hidden="true">

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="IN51_RejList.aspx.vb" Inherits="GSBWeb.IN51_RejList" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default">
                <div class="NormalHeader" style="/*text-align: left; font-size: medium; font-weight: bold;
                    ...
                    ข้อมูลรายการที่ถูก Reject IN51</div>
                <table align="left" width="100%">
                    ...
                    <tr>
                        ...
                        <td width="90%" colspan="5">
                            <asp:GridView ID="gvIN51" runat="server" AutoGenerateColumns="False" PageSize="20"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText=" เลขที่บัญชี">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="hpACCNO" runat="server" CommandName="Select"></asp:LinkButton>
                                            <asp:HiddenField ID="HF_TMP_IN51ID" runat="server" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black" />
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />

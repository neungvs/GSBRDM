<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FW53_RejList.aspx.vb" Inherits="GSBWeb.FW53_RejList" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default">
                <div class="NormalHeader" style="/*text-align: left; font-size: medium; font-weight: bold;
                    ...
                    ข้อมูลรายการที่ถูก Reject FW53</div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText=" เลขที่บัญชี">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="HF_TMP_FW53ID" runat="server" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"
                                            ForeColor="Black"/>
                                        <ItemStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" />
                                    ...
                                    <asp:TemplateField HeaderText="GSB_BUY_CCY_AMT">
                                        <ItemTemplate>
                                            <asp:Label ID="lblGSB_BUY_CCY_AMT" Text='<%# Bind("GSB_BUY_CCY_AMT") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" BorderColor="#EEEEEE" BackColor="#CCCCCC" BorderWidth="1" CssClass="td-center"

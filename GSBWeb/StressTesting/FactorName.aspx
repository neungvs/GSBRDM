<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FactorName.aspx.vb" Inherits="GSBWeb.Factor_Name" MasterPageFile="~/Site.Master" %>
            ...
            <div class="rows">
                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <table width="100%" border="0">
                                        <tr>
                                            <td align="left" width="100px">
                                                <asp:DropDownList ID="cbListTime" runat="server" Height="30px" Width="150px" CssClass="TextBoxRoundCorrner">
                                                </asp:DropDownList></td>
                                            <td align="left">&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="NormalHeader" style="background-color: #FF388C; color: #FFFFFF;">
                        <table width="100%" border="0" id="tbFactorNameHeader" runat="server">
                            <tr valign="middle" style="height: 40px;">
                                <td align="left">
                                    <font color="#FFFFFF">Factor Name</font>
                                </td>
                                <td align="right">&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td>
                                <asp:GridView ID="gvFactorName" runat="server" AutoGenerateColumns="False" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ชื่อตัวแปรทางเศรษฐกิจ">
                                            <ItemTemplate>
                                                <asp:Label ID="lbFactorName" Text='<%# Bind("FactorName") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="หน่วย">
                                            <ItemTemplate>
                                                <asp:Label ID="lbFactorUnit" Text='<%# Bind("FactorUnit") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="คำอธิบาย">
                                            <ItemTemplate>
                                                <asp:Label ID="lbFactorDesc" Text='<%# Bind("FactorDesc") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left">
                                                                <asp:TextBox ID="txtFactorName" runat="server" class="form-control" Style="margin-bottom: 2px; font-size: medium; text-align: left"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="text-align: right; font-size: medium">หน่วย&nbsp:&nbsp
                                                            </td>
                                                            <td style="text-align: left">
                                                                <asp:TextBox ID="txtFactorUnit" runat="server" class="form-control" Style="margin-bottom: 2px; font-size: medium; text-align: left"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left">
                                                                <asp:TextBox ID="txtFactorDesc" runat="server" class="form-control" Style="margin-bottom: 2px; font-size: medium; text-align: left"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>

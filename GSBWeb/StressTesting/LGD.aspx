<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LGD.aspx.vb" Inherits="GSBWeb.LGD" MasterPageFile="~/Site.Master" %>
            ...
            <div class="rows">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="NormalHeader" style="background-color: #FF388C; color: #FFFFFF;">
                        <table width="100%" border="0" id="tbLgdHeader" runat="server">
                            <tr valign="middle" style="height: 40px;">
                                <td align="left">
                                    <font color="#FFFFFF">LGD</font>
                                </td>
                                <td align="right">&nbsp;&nbsp;&nbsp;
                                ...
                                <asp:GridView ID="gvLgd" runat="server" AutoGenerateColumns="False" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="สถานการณ์ภาวะวิกฤต">
                                            <ItemTemplate>
                                                <asp:Label ID="lbScenario" Text='<%# Bind("Scenario") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" Width="95px" BorderColor="Gray" BorderWidth="1" />
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="ค่า LGD Scalar">
                                            <ItemTemplate>
                                                <asp:Label ID="lbStressLgdScalar" Text='<%# Bind("StressLgdScalar") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" Width="95px" BorderColor="Gray" BorderWidth="1" />

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GrowthWriteOff.aspx.vb" Inherits="GSBWeb.GrowthWriteOff" MasterPageFile="~/Site.Master" %>
            ...
            <div class="rows">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="NormalHeader" style="background-color: #FF388C; color: #FFFFFF;">
                        <table width="100%" border="0" id="tbGrowthWriteOffHeader" runat="server">
                            <tr valign="middle" style="height: 40px;">
                                <td align="left">
                                    <font color="#FFFFFF">Loan Growth & Write Off</font>
                                </td>
                                <td align="right"></td>
                            </tr>
                        </table>
                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td>
                                <asp:GridView ID="gvGrowthWriteOff" runat="server" AutoGenerateColumns="False" PageSize="10"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="PD_SEGMENT">
                                            <ItemTemplate>
                                                <asp:Label ID="lbPdSegment" Text='<%# Bind("PdSegment") %>'
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Loan Growth">
                                            <ItemTemplate>
                                                <asp:Label ID="lbLoanGrowthPerc" Text='<%# Bind("LoanGrowthPerc") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" Width="95px" BorderColor="Gray" BorderWidth="1" />
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Write Off">
                                            <ItemTemplate>
                                                <asp:Label ID="lbWriteOffPerc" Text='<%# Bind("WriteOffPerc") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" Width="95px" BorderColor="Gray" BorderWidth="1" />
                                            ...
                                            <td align="center">
                                                ...
                                                <asp:GridView ID="grvImportExcel" runat="server" AutoGenerateColumns="False" PageSize="5"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="PD_SEGMENT">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbPdSegment" runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" BorderColor="Gray" BorderWidth="1" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Loan Growth">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbLoanGrowth" runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" BorderColor="Gray" BorderWidth="1" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderText="Write Off">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbWriteOff" runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" BorderColor="Gray" BorderWidth="1" CssClass="td-center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" Width="10%" BorderColor="Gray" BorderWidth="1" />
                                                        </asp:TemplateField>

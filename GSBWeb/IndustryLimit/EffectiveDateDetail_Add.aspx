<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="EffectiveDateDetail_Add.aspx.vb" Inherits="GSBWeb.EffectiveDateDetail_Add" %>
                                        ...
                                        <tr>
                                            ...
                                            <td width="200px" colspan="1" style="text-align: left">
                                                <asp:DropDownList ID="ddlMKTCODE" Width="200px" runat="server" AutoPostBack="true"
                                                    class="form-control" EnableViewState="true">
                                                </asp:DropDownList>
                                            </td>
                                            <td width="50px">
                                                &nbsp;
                            ...
                            <div class="panel panel-danger" width="100%">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="150px" style="text-align: left;">
                                            <asp:TextBox ID="txtIndustryLimitAmount" OnBlur="addCommas(this)" onfocus="removeCommas(this)"
                                                Width="100%" AutoPostBack="true" runat="server" class="form-control" Style="margin-bottom: 2px;

...
Public Class SettingReceiveMailReport_2_5
    ...
    Private Sub LoadData()
        gvEmail.DataSource = emBiz.GetDataReceiveMail("CPM 13.5")
        gvEmail.DataBind()
    End Sub
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If Not String.IsNullOrEmpty(txtEmail.Text) Then
                _chkEmail = emBiz.CheckEmail(txtEmail.Text, "CPM 13.5")
            End If
            ...
            If Not String.IsNullOrEmpty(hdEmail.Value) Then
                emBiz.UpdateEmail(txtEmail.Text, hdEmail.Value, "CPM 13.5")
            Else
                emBiz.InsertEmail(txtEmail.Text, "CPM 13.5")
            End If
    ...
    Protected Sub OnRowDeleting(sender As Object, e As GridViewDeleteEventArgs)
        ...
        _result = emBiz.DeleteEmail(lblEmail.Text, "CPM 13.5")

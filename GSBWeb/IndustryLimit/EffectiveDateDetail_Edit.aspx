<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="EffectiveDateDetail_Edit.aspx.vb" Inherits="GSBWeb.EffectiveDateDetail_Edit" %>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="text-align: center">
                                                ...
                                                <asp:LinkButton ID="btnCancle" Width = "90px"  class="btn btn-danger" ToolTip="ยกเลิก" CausesValidation="false"
                                                    runat="server" Style="text-decoration: none"> <span aria-hidden="true" class="glyphicon glyphicon-remove"></span>&nbsp; ยกเลิก </asp:LinkButton>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="5%">

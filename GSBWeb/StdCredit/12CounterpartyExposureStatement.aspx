...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="contentTableAreaStyle">
        <div>
            <h1>Counterparty Exposure Statement</h1>
            </br>
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" Visible="false">
                ...
                <table class="tabletypereport1">
                    <tr>
                        <td colspan="3">Counterpaty Selection</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="TxtObligorNameSch" runat="server"></asp:TextBox>
                            <asp:Button ID="BthObligorNameSch" runat="server" Text=" " /></td>
                        <td>&nbsp;</td>
                        <td>
                            <asp:DropDownList ID="DrlObligorName" runat="server" DataTextField="OBLIGORNAME" DataValueField="OBLIGORNAME" Width="200px"></asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>

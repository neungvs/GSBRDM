...
Partial Class _22CapitalOrganization
    ...
    Protected Sub btnOk_Click(sender As Object, e As EventArgs) Handles btnOk.Click
        ...
        clsDB.CallReportPara(ReportViewer2, "Rpt_Capital_Adequacy_By_Organization_Structure", pTimeID, pScenarioID, pSimpComp, pCemOem)

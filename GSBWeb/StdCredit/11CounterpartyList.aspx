                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButton id="rdoCounterparties" runat="server" GroupName="group1" Text="Counterparties" Checked="true"/><br />
                                        <asp:RadioButton id="rdoExposure" runat="server" GroupName="group1" Text="Exposure"/>
                                    </td>
                                    </tr>
                                <tr>
                                    <td colspan="2">Show Top X Items</td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                ...
                                <tr>
                                    <td colspan="2">Sort By Measure</td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TxtContain" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="DrlAssetType" runat="server" DataTextField="ASSETTYPEDESC" DataValueField="ASSETTYPEDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="DrlCRMType" runat="server" DataTextField="CRMTYPEDESC" DataValueField="CRMTYPEDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="DrlObligorType" runat="server" DataTextField="MARKETPARTICIPANTTYPEDESC" DataValueField="MARKETPARTICIPANTTYPEDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="DrlArrearsStatus" runat="server" DataTextField="ARREARSSTATUSDESC" DataValueField="ARREARSSTATUSDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="DrlExternalCreditRating" runat="server" DataTextField="EXTERNALCREDITRATINGTYPEDESC" DataValueField="EXTERNALCREDITRATINGTYPEDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DrlObligorIndustryGroup" runat="server" DataTextField="INDUSTRYGROUPDESC" DataValueField="INDUSTRYGROUPDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="DrlExposureCurrency" runat="server" DataTextField="CURRENCYDESC" DataValueField="CURRENCYDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="DrlCountryOfOrigin" runat="server" DataTextField="COUNTRYDESC" DataValueField="COUNTRYDESC" Width="200px"></asp:DropDownList>
                                                </td>
                                                <td>&nbsp; </td>
                                            </tr>
                                        </table>

...
Partial Class _1CRDashboard
    ...
    Protected Sub btnOk_Click(sender As Object, e As EventArgs) Handles btnOk.Click
        'clsDB.CallReport(ReportViewer2, "Rpt_Credit_Dashboard")
        ...
        'pPdfCdf.Values.Add("PDF")

        'clsDB.CallReportPara(ReportViewer2, "Rpt_Loss_Distribution", pTimeID, paraScenarioId, pPdfCdf)

        clsDB.CallReportPara(ReportViewer2, "Rpt_Credit_Dashboard", pTimeID, paraScenarioId, paraSimpComp, paraOemCem)

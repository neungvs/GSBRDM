...
Public Class clsboldb
    ...
    Public Function CallReport(ByVal rePoerserver As ReportViewer, ByVal ReportName As String)
        Dim strReportServer As String = ConfigurationManager.AppSettings("ReportServiceURL").ToString()
        Dim strUserName As String = ConfigurationManager.AppSettings("Username").ToString()
        Dim strPassword As String = ConfigurationManager.AppSettings("Password").ToString()
